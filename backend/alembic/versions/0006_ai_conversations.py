"""История ИИ-чатов: диалоги сотрудника и реплики.

Revision ID: 0006_ai_conversations
Revises: 0005_product_detail_fields
"""
...
revision: str = "0006_ai_conversations"
down_revision: str | None = "0005_product_detail_fields"
branch_labels = None
depends_on = None
